      		  ...
      		  <div class="col-md-6">
        		    <div class="card">
							<div class="card-header text-center">
								<h1 class="H1-color" style="color=#ffffff"> اكفل يتيم </h1>
							</div>
...
{{--                                        هون بتحط يلي تحت مشان تنعرض الرسالة--}}
                                        ...
                                        @endif
											...
											<div class="form-group">
                                                    ...
                                                    <select name="donator_address" id="cars">
					<option value= "supervisor">كفالة اسرة</option>
					<option value=" volunteer">كفالة طالب علم </option>
